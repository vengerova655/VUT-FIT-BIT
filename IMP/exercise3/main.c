...
//POZNAMKY z cvicenia:
//duty cycle -> nezalezi od T iba pomer
//cim vacsi mod tym vacsia moznost
//fr zisits-> celk/pre frekv
...
//vypocet pov -> perioda = 40mikros,  pre->8 mod->256(0xFF) ->celkova per = 0.01953 mikros -> hotova f = 51.2Mhz
